    ...
    try:
        ...
        if db.coupons.count_documents({}) == 0:
            db.coupons.insert_many([
                {'code': 'WELCOME10', 'type': 'percentage', 'value': 10, 'max_discount': 500, 'min_amount': 1000, 'expiry_date': '2030-12-31', 'max_uses': 100, 'current_uses': 0, 'is_active': True, 'description': '10% Off'},
                {'code': 'GYM500', 'type': 'flat', 'value': 500, 'max_discount': 500, 'min_amount': 5000, 'expiry_date': '2030-12-31', 'max_uses': 50, 'current_uses': 0, 'is_active': True, 'description': 'Flat 500 Off'}
            ])
